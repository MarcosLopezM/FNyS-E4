...
\hypersetup{
    ...
    pdfkeywords={Facultad de Ciencias, UNAM, Física Atómica y Materia Condensada},%
    unicode=true%
}
...
\newcommand*{\homeworknumber}{Tarea 5}
\newcommand*{\name}{Marcos López Merino}
\DTMsavedate{duedate}{2023-12-04}
